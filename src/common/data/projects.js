const projects = [
  {
    ...
    files: [
      { name: "Innovaweb Landing.Zip", size: "3.25 MB", link: "#" },
      { name: "Innovaweb Admin.Zip", size: "3.15 MB", link: "#" },
      { name: "Innovaweb Logo.Zip", size: "2.02 MB", link: "#" },
